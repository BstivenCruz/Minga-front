...
export default function Signup() {
  return (
    ...
    <div className="w-1/2 object-cover">
      <img className=" object-cover content-center h-screen w-screen" src={signup} />
    </div>
    <div className="flex flex-col items-center justify-center gap-3  w-1/2 h-screen">
      ...
      <form className="flex flex-col w-1/2  justify-center gap-4 h-[40%] ">
        <label>
      ...
      <p>
        Already have an account? <Anchor to='/signin' className=" text-dos">Log in</Anchor>
      </p>
      <p>
        Go back to
